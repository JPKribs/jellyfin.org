...
If you run into issues, please prefix bug reports with "[12.0]". As always, back up your database before testing, as there are changes that prevent rolling back without restoring from a backup.
