...
As mentioned in the last [State of the Fin](/state-of-the-fin-2026-01-06#versioning), we're dropping the major version "10" from our naming scheme. With 10.11.x being the final release branch to use it, the next major release will move directly to 12.0.
